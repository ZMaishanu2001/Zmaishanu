			    	...
			    	<div class="row">
						<div class="col-md-4">				
							<div class="list-group">
							  ...
							  <a href="viewsuggestion.php" class="list-group-item active"> <span class="glyphicon glyphicon-comment"></span> View Suggestions/ Comments</a>
						...
						<div class="col-md-8">
							...
							<div class="table-responsive">
								<table width="80%" class="table table-stripped table-hover">
								    <tr>
								    <th colspan="4" class="info"><center><h3>View Suggestions</h3></center></th>
								    </tr>
								    <tr>
								    <td>S/N</td>
								    <td>Date</td>

					...
					<div class="row">
						<div class="col-md-3">
							<div class="list-group">
							  ...
							  <a href="logout.php" class="list-group-item"> <span class="glyphicon glyphicon-log-out"></span> Log Out</a>							</div>
						</div>
						<div class="col-md-7">
							<table width="80%" class="table table-stripped table-hover table-bordered">
							    <tr>
							    <th colspan="2" class="info"><center><h3>Hemoglobin Type Report Sheet</h3></center></th>
							    </tr>
							    <tr>
								    <th> Full Name:</th>
							    ...
							    <tr>
								    ...
								    <td>Hemoglobin S -Ve</td>								    
								</tr>
								    <th>Suggestion:</th>
								    <td>
								    	Having Hemoglobin S -Ve means you are not a Sickle Cell Carrier
										See Your Doctor!
                                    </td>
							    </tr>
							    <tr>							    </tr>

					...
					<div class="row">
						<div class="col-md-3">
							<div class="list-group">
							  ...
							  <a href="about.php" class="list-group-item"> <span class="glyphicon glyphicon-bullhorn"></span> About XpertDiab</a>
						...
						<div class="col-md-7">
							<table width="80%" class="table table-stripped table-hover table-bordered">
							    <tr>
							    <th colspan="2" class="info"><center><h3>Sickle Cell Anaemia Report Sheet</h3></center></th>
							    </tr>
							    <tr>
								    <th> Full Name:</th>
							    ...
							    <tr>
								    ...
								    <th>Suggestion:</th>
								    <td>
								    	Being AS a harmless condition,The suggestion below can be followed to maintain a sound health for                                        you and your Family:
								    <ol>
								    	<li>Marry a partner that has AA</li>
										<li>Have early SCD test for all your children </li>
										<li>Exercise</li>
										<li>Education</li>
									</ol>
									</td>

			...
			<div class="panel panel-primary">
			    ...
			    <div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-7">
							<center>
							  <h3 style="font-family: monotype corsiva;">Genotype Test Result</h3>
							</center>
							<?php echo $msg; ?>
							<form class="form-horizontal" role="form" action="dipstick.php" method="post">
							  <div class="form-group">
							    <label for="inputEmail1" class="col-lg-5 control-label">Enter your Genotype Group</label>
							    <div class="col-lg-7">
							      <select name="dipstick" class="form-control">
							      	<option></option>
							      	<option value="red">SS</option>
							      	<option value="blue">AS</option>
							      </select>
							    </div>
							  </div>

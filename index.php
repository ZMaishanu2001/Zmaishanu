...
<div id="address">
    ...
    <address>El-Maishan Enterprise, View Pion Nigeria Limited, Kaduna.<br> No. 11 Mai'unguwa Road, Kinkinau G.R.A. Kaduna.<hr> </address>
</div>
...
<div id="contact"><br>
    ...
    <div>
        <form action="success.php" method="POST" onsubmit="return validate(this)">
...
<?php	
	if(isset($_POST['submit']))
	{
		...
		if(!$result)
		{
			echo<<<_end
				<script>
					var answer=confirm("Your Message not ssuccesfully");
					if(!answer)
						{
							echo "Your Message not ssuccesfully"
						}
						else
						{
							echo "Your Message is ssuccesfully send";
						}
					{
